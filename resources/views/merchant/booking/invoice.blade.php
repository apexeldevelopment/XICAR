...
{{--                        </a>--}}
                        <a href="{{route('admin.sendinvoice',$booking->id)}}">
                            <button class="btn btn-icon btn-warning float-right" style="padding:5px;margin:10px;width:150px;"><i class="icon fa-send"></i>
                                @lang("$string_file.invoice")
                            </button>
                        </a>
                        {{--<a href="{{route('admin.sendinvoice.brevo',$booking->id)}}">--}}
                        {{--    <button class="btn btn-icon btn-danger float-right" style="margin:10px;width:115px;"><i class="icon fa-send"></i>--}}
                        {{--    </button>--}}
                        {{--</a>--}}
                    </div>
                    ...
                    <div class="panel-body container-fluid printableArea">
                        <div class="row">
                            <div class="col-lg-3 col-md-6">
                                ...
                                <address>
                                    {{ is_demo_data($booking->Merchant->merchantFirstName." ".$booking->Merchant->merchantLastName, $booking->Merchant) }}<br>
                                    {{ is_demo_data($booking->Merchant->merchantAddress, $booking->Merchant) }}
                                    <br>
                                    <abbr title="Mail">@lang("$string_file.email"): </abbr>{{ is_demo_data($booking->Merchant->email, $booking->Merchant) }}
                                    <br>
                                    <abbr title="Phone">@lang("$string_file.phone"): </abbr>{{ is_demo_data($booking->Merchant->merchantPhone, $booking->Merchant) }}
                                    <br>
                                </address>
                            </div>
                            <div class="col-lg-3 offset-lg-6 text-right">
                                ...
                                <br>
                                <span class="font-size-16">{{ is_demo_data($booking->User->UserName, $booking->Merchant) }}</span> <br>
                                <address>
                                    <abbr title="Mail">@lang("$string_file.email"): </abbr>{{ is_demo_data($booking->User->email, $booking->Merchant) }}
                                    <br>
                                    <abbr title="Phone">@lang("$string_file.phone"): </abbr>{{ is_demo_data($booking->User->UserPhone, $booking->Merchant) }}
                                    <br>
                                </address>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6 col-sm-12">
                                ...
                                <div class="row">
                                    <div class="col-xl-6 col-md-6 col-sm-6 text-center">
                                        ...
                                        <h5 class="profile_name">{{ is_demo_data($booking->Driver->fullName, $booking->Merchant) }}</h5>
