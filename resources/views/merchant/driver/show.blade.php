                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 col-xs-12 mt-20">
                                    <div class="row">
                                        ...
                                        @endif
                                        @if($config->driver_ssn_number_enable == 1 && isset($driver->driver_ssn_number) && !empty($driver->driver_ssn_number))
                                            <div class="col-md-4 col-sm-4 col-xs-12 py-2 mb-3">
                                                <div class="border-left-success">
                                                    <div class="">
                                                        <div class="row no-gutters align-items-center">
                                                            <div class="col mr-2">
                                                                <div class="h6  text-uppercase mb-1">@lang("$string_file.driver_ssn_number")</div>
                                                                <div class="h6 mb-0 font-weight-400"
                                                                     style="color:#7c8c9a">{{$driver->driver_ssn_number}}</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
...
+                                                        <span class="">@lang("$string_file.vehicle_make")  </span> : {{$vehicle_details?->VehicleMake?->VehicleMakeName}} <br>
                                    ...
                                    @if($config->driver_guarantor_details == 1 && !empty($driver->driver_guarantor_details))
                                        @php
                                        ...
                                        @endphp
                                    <h5>@lang("$string_file.guarantor") @lang("$string_file.details")</h5>
                                    <hr>
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="dataTable">
                                            <thead>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <a href="{{ $image }}" target="_blank"><img src="{{ $image }}" style="width:60px;height:60px;border-radius: 10px"></a>
                                                    </td>
                                                    <td>
                                                        {{$details['name']}}
                                                    </td>
                            ...
                            @if($driver->signupStep <= 8 && $driver->reject_driver !=2)
                                <div class="float-right mt-10">
                                    @if($driver->signupStep == 8)
                                        @php
                                        $guarantor_details_filled = NULL;
                                        if($config->driver_guarantor_details == 1 && !empty($driver->driver_guarantor_details) && $driver->CountryArea->need_driver_guarantor_details == 1){
                                            $guarantor_details_filled = 1;
                                        }
                                        elseif($config->driver_guarantor_details == 1 && empty($driver->driver_guarantor_details) && $driver->CountryArea->need_driver_guarantor_details == 1){
                                            $guarantor_details_filled = 2;
                                        }
                                        @endphp
                                        <a href="#" onclick="verifyDriver({{ $driver->id }}, 1, {{ $guarantor_details_filled ?? 'null' }})">
                ...
                <form class="form-group" action="{{ route('merchant.driver-vehicle-reject') }}" method="post">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <h5>@lang("$string_file.training") @lang("$string_file.profile") @lang("$string_file.rejected")</h5>
                            </div>
                            @endif
                            @if(!empty($driver->driver_guarantor_details))
                                ...
                                <div class="col-md-6">
                                    <input type="checkbox" value="true"
                                           name="reject_guarantor_details"> @lang("$string_file.reject") @lang("$string_file.guarantor") @lang("$string_file.details")
                                </div>
                            @endif
...
@section('js')
    ...
    <script>
        function verifyDriver(driverId, status, guarantor_details_filled = null) {
            const url = `{{ route('merchant.driver-vehicle-verify', [':driver_id', ':status']) }}`;
            const finalUrl = url.replace(':driver_id', driverId).replace(':status', status);
            if(guarantor_details_filled == 2){
                swal({
                    title: '@lang("$string_file.unable")." ".@lang("$string_file.to")." ".@lang("$string_file.approve")',
                    text: '@lang("$string_file.guarantor_details_missing_approval_warning")', // customize this line as needed
                    icon: "warning",
                    dangerMode: true,
                });
            }
                ...
                swal({
                    ...
                    text: '@lang("$string_file.approve") @lang("$string_file.driver") ?', // customize this line as needed
                    icon: "warning",
                    buttons: true,
                    dangerMode: true,
                }).then((confirmed) => {
