                    ...
                    <form method="POST" class="steps-validation wizard-notification"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="emailAddress5">
                                        @lang("common.current") @lang("common.status")<span
                                                class="text-danger">*</span>
                                    </label>
                                    <select class="form-control" name="status">
                                        <option value="0"
                                                @if($goods->status==0)selected @endif>@lang("common.inactive")</option>
                                        <option value="1"
                                                @if($goods->status==1)selected @endif>@lang("common.active")</option>
                                    </select>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control"
                                              id="description"
                                              name="description"
                                              placeholder="@lang("common.description")">{{ $goods->GoodDescription }}
                                    </textarea>
                                </div>
                            </div>
