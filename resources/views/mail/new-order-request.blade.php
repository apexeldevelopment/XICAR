...
<div class="container content-width" style="background-color: #ffffff;max-width: 700px;min-width:300px;margin: 20px auto;font-family: Roboto,RobotoDraft,Helvetica,Arial,sans-serif;">
    ...
    <div class="user-details" style="font-size: 13px; font-weight: 400;text-align: left;padding-left:25px; padding-right:25px;">
        ...
        <p>{{$order->BusinessSegment->full_name}}</p>
        <p>
        @lang("$string_file.new_order_mail_message")
        </p>
    </div>
            ...
            <tr>
                ...
                <td style="border-bottom: none; padding:0;">
                    ...
                    <h6 style="font-weight:900;font-size:14px;margin:0;">
                        ...
                        $order->Merchant)}}
                        {{--{{date_format($order->created_at,'D, M d, Y H:i a')}}--}}
                    </h6>
                </td>
                <td style="border-bottom: none;padding:0; text-align: right;">
                    ...
                    <h6 style="font-weight:900;font-size:14px; margin:0;color: #79b33b;">@lang("$string_file.new_order")</h6>
                </td>
            </tr>
            </tbody>
        </table>
                        ...
                        <tr>
                            <td style="border-bottom: none; padding:0;">
                                <p style="margin:0;font-weight:normal;line-height:1.6">
                                    @lang("$string_file.name") : {{is_demo_data($order->User->first_name.' '.$order->User->last_name,$order->Merchant)}}<br>
                                    @lang("$string_file.phone") : {{is_demo_data($order->User->UserPhone)}} <br>
                                    @lang("$string_file.email") : {{is_demo_data($order->User->email)}} <br>
                                </p>
                            </td>
                            <td style="border-bottom: none; padding:0;width:150px;">
                                <p style="margin:0;font-weight:normal;line-height:1.6">{{$order->drop_location}}</p>
                            </td>
                        </tr>
                        </tbody>
                    </table>
