...
<head>
    ...
    <title>{{$merchant->BusinessName}} - Company Login</title>
...
<div class="page" data-animsition-in="fade-in" data-animsition-out="fade-out">
    <div class="page-content">
        <div class="page-login-v2">
            @if ($company->company_background_image)
                <img class="background-taxi" src="{{get_image($company->company_background_image,'company_background_image',$merchant->id,true)}}">
            @else
                <img class="background-taxi" src="https://msprojects.apporioproducts.com/multi-service-v3/public/theme/examples/images/login.jpg" width="50px" height="50px">
            @endif
        </div>
        ...
        <div class="page-login-main animation-slide-right animation-duration-1">
            ...
            <h3 class="font-size-24">{{ $taxiCompanyString }}</h3>
            <form method="post" action="{{ route('taxicompany.login.submit','test-apporio') }}">
                @csrf
