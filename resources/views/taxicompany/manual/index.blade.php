        ...
        <div class="page-content">
            ...
            <div class="panel panel-bordered">
                ...
                <div class="panel-body container-fluid">
                    <form method="POST" class="steps-validation wizard-notification" enctype="multipart/form-data" action="{{ route('taxicompany.book.manual.dispatch') }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 custom-hidden">
                                <div class="form-group">
                                    <label class="form-control-label" for="corporate_div"> @lang("$string_file.corporate_user")
                                        <span class="text-danger">*</span>
                                    </label>
                        ...
                        <div class="row ml-10">
                            ...
                            <div class="form-group pull-right ml-2 mr-2 custom-hidden" id="full_details_div">
                                <a target="_blank" id="full_details"
                                   disabled>
                                    <div class="icondemo vertical-align-middle">
                                        <i class="icon wb-user-circle ml-20" aria-hidden="true" style="font-size: 30px;"></i>
                                        <div class="icon-title">@lang("$string_file.full_details")</div>
                                    </div>
                                </a>
                            </div>
{{--                            <div class="form-group pull-right mr-2 custom-hidden" id="full_details_div">--}}
...
{{--                            </div>--}}
                        ...
                        <div class="row mt-10">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="placeTextarea">@lang("$string_file.service_details")
                                    </label>
    ...
    <script>
        ...
        $('#country').change(function () {
            ...
            $.ajax({
                ...
                method: 'POST',
                url: "{{ route('taxicompany.ajax.area') }}",
                data: {id: val},
