            ...
            <div class="panel panel-bordered">
                ...
                <div class="panel-body container-fluid">
                    <form method="POST" class="steps-validation wizard-notification" enctype="multipart/form-data"
                          action="{{ route('taxicompany.book.manual.dispatch') }}" onsubmit="return validation()">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
    ...
    <script>
        ...
        $('#check_user_details').click(function () {
            ...
            if (user_phone == "") {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    url: "{{route('taxicompany.SearchUser')}}",
            ...
            if($("#pickup_location").val().length > {{$bookingConfig->autocomplete_start}})
            {
                ...
                start.addListener('place_changed', function () {
                    ...
                    $.ajax({
                        ...
                        method: 'POST',
                        url: "{{route('taxicompany.checkArea')}}",
                        data: {latitude: pickupLat,longitude:pickupLng,merchant_id :merchant_id,segment_id: segment},
                        success:function (data) {
                            if(data.result == 1){
                                // console.log(data);
        ...
        function checkestimate() {
            ...
            $.ajax({
                ...
                method: 'POST',
                url: "{{route('taxicompany.estimatePrice')}}",
                data: {
                    distance: distance,
                    ride_time: ride_time,
                    service: service,
                ...
                success: function (data) {
                    ...
                    if(data.result == 1){
                        ...
                        $.ajax({
                            ...
                            method: 'POST',
                            url: "{{route('taxicompany.getPromoCode')}}",
                            data: {
        ...
        function getService() {
            ...
            if (area_id != "" && vehicle_type_id != '') {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    url: "{{route('taxicompany.area.services')}}",
                    data: {
                        area_id: area_id,
                        segment_id:segment,
        ...
        function checkService() {
            ...
            if (val !== "") {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    url: "{{route('taxicompany.price.card.service.config')}}",
                    data: {
                ...
                if(service == 4){
                    ...
                    if(drop_latitude != ''){
                        ...
                        $.ajax({
                            ...
                            method: 'POST',
                            url: "{{route('taxicompany.manual.checkArea')}}",
                            data: {
                                area_id: manual_area,
        ...
        function getMapDrivers(radius_val) {
            ...
            $.ajax({
                ...
                method: 'POST',
                url: "{{ route('taxicompany.getDriverOnMap') }}",
                data: {
                    radius: radius,
                ...
                success: function (data) {
                    console.log("get_drivers_on_map: "+data);
        ...
        function checkPriceCard() {
            ...
            $.ajax({
                ...
                method: 'POST',
                url: "{{route('taxicompany.checkPriceCard')}}",
                data: {
                    vehicle_type: vehicle_type,
                    service: service,
                    area: manual_area,
        ...
        function checkArea() {
            ...
            $.ajax({
                ...
                method: 'POST',
                url: "{{route('taxicompany.checkArea')}}",
                data: {latitude: pickupLat,longitude:pickupLng,merchant_id :merchant_id,service:service,manual_area:manual_area,segment_id: segment},
                success:function (data) {
                    // console.log(data);
                    if(data.result == 1){
                        if ($('#pickup_latitude').val()) {
