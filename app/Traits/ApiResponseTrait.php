...
trait ApiResponseTrait{
    ...
    protected function successfullResponse($message, $data = [], $additional_data =[])
    {
        ...
        return response()->json(['version' => $api_version,"result" => "1", 'message' => $message, 'data' => $data, 'additional_data'=>$additional_data]);
    }
    ...
    protected function pendingResponse($message)
    {
        ...
        return response()->json(['version' => $api_version,"result" => "2", 'message' => $message]);
    }
    protected function failedResponseWithData($message, $data = [])
    {
        ...
        return response()->json(['version' => $api_version,"result" => "0", 'message' => $message, 'data'=>$data]);
    }
}
