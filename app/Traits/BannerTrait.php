...
trait BannerTrait{
    ...
    {
        $query = AdvertisementBanner::with('BusinessSegment')->select('name as banner_name','id','image as banner_images','business_segment_id','action_type','category_id','product_id','redirect_url','home_screen_holder_id','segment_id', 'image_height', 'image_width')
