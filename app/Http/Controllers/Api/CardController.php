        ...
        try{
            ...
            switch ($request->payment_option) {
                case "STRIPE":
                    ...
                    if (is_array($card)) {
                        $stripeCardData = $this->StripeCard($user->id,$card['id'], $request->payment_option,null,$request->stripe_card_number);
...
//                $cc_num_pre = substr($request->cc_number, -4);
    ...
    public function StripeCard($user_id, $id, $payment_option_id, $type = null,$card_number = null)
    {
